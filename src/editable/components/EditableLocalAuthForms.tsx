...
const inputClass = 'h-12 rounded-lg border border-[var(--editable-border)] bg-white px-4 text-base font-bold text-black outline-none transition placeholder:text-black/45 focus:border-black focus:bg-white'
