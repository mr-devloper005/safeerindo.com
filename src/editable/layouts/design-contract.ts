...
export const editableRootStyle = {
  ...
  '--slot4-page-bg': '#fff7f0',
  '--slot4-page-text': '#111111',
  '--slot4-panel-bg': '#fff1e8',
  '--slot4-surface-bg': '#ffffff',
  '--slot4-muted-text': '#4b4541',
  '--slot4-soft-muted-text': '#67605b',
  '--slot4-accent': '#f62eb8',
  '--slot4-accent-fill': '#f62eb8',
  '--slot4-accent-soft': '#b7dcff',
  '--slot4-accent-warm': '#ffbd36',
  '--slot4-accent-orange': '#ff6b2a',
  '--slot4-dark-bg': '#050505',
  '--slot4-dark-text': '#ffffff',
  '--slot4-media-bg': '#e9ddd4',
  '--slot4-cream': '#fff1e8',
  '--slot4-warm': '#fff7f0',
  '--slot4-lavender': '#b7dcff',
  '--slot4-gray': '#f7f7f7',
  '--slot4-body-gradient': 'linear-gradient(180deg, #fff7f0 0%, #fff1e8 42%, #ffffff 100%)',
} as CSSProperties
...
export const editableDesignContract = {
  ...
  type: {
    ...
    heroTitle: 'text-4xl font-black leading-[1.02] tracking-normal sm:text-5xl lg:text-6xl',
  ...
  button: {
    primary: `inline-flex items-center justify-center rounded-full ${editablePalette.darkBg} px-7 py-3 text-sm font-black text-white transition hover:opacity-90`,
    secondary: `inline-flex items-center justify-center rounded-full border border-black/20 ${editablePalette.surfaceBg} px-7 py-3 text-sm font-black ${editablePalette.surfaceText} transition hover:bg-black/[0.03]`,
    accent: `inline-flex items-center justify-center rounded-full ${editablePalette.accentBg} px-7 py-3 text-sm font-black text-white transition hover:opacity-90`,
  },
  media: {
